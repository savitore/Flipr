...
class Cipla extends StatefulWidget {
  const Cipla({Key? key}) : super(key: key);

  @override
  State<Cipla> createState() => _CiplaState();
}

class _CiplaState extends State<Cipla> {
  ...
  Future<void> getHttprequest() async {
    String url = "https://dataapiservice.onrender.com/Cipla";
    print("hi");
    try{
                ...
                child: SingleChildScrollView(
                  child: Column(
                      children:<Widget> [
                        ...
                        Row(
                          children: [
                            Text("CIPLA",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)
                          ],
                        ),
                        Row(
                          children: [
