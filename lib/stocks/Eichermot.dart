...
class Eichermot extends StatefulWidget {
  const Eichermot({Key? key}) : super(key: key);

  @override
  State<Eichermot> createState() => _EichermotState();
}

class _EichermotState extends State<Eichermot> {
  ...
  String dropdownValueS= 'EICHERMOTORS';
  ...
  Future<void> getHttprequest() async {
    String url = "https://dataapiservice.onrender.com/EicherMotor";
    print("hi");
    try{
                ...
                child: SingleChildScrollView(
                  child: Column(
                      children:<Widget> [
                        ...
                        Row(
                          children: [
                            Text("EICHER MOTORS",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)
                          ],
                        ),
                        Row(
                          children: [
